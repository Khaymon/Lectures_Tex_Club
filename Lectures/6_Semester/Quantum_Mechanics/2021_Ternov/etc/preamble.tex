...
% Especially for квантмех
\newcommand{\bra}[1]{\left \langle #1 \right|}
\newcommand{\ket}[1]{\left| #1 \right \rangle}
\newcommand{\scp}[2]{\left \langle #1 \mid #2 \right \rangle}

% CONTENT

\newcommand{\addcontsec}[1]{\section*{#1}\addcontentsline{toc}{section}{#1}}
\newcommand{\addcontsubsec}[1]{\subsection*{#1}\addcontentsline{toc}{subsection}{#1}}
